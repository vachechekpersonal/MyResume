...
| 9 | Mutation testing | Run Stryker.NET locally over Core; fix any survivors that reveal weak tests. Record the score in the README. Not added to CI (too slow for a small project). |
